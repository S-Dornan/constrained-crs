...
EXPERIMENTS=(
  "l16-smoke_1_baseline:8:16384:20:experiment-configs/L16-QA:smoke-finding.yaml:smoke-fixing.yaml"
  "l16-smoke_2_stepdown:6:8192:15:experiment-configs/L16-QA:smoke-finding.yaml:smoke-fixing.yaml"
)
